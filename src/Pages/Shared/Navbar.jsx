        ...
        <div>
            <div className="navbar fixed z-10 bg-opacity-10 bg-black">
                ...
                <div className="dropdown">
                    ...
                    <a className="btn btn-ghost tracking-widest font-bold text-2xl text-white">Bistro Boss</a>
                </div>
                ...
                <div className="navbar-end">
                    {
                        user ? <>
                            ...
                            <Link to="/login" className="btn btn-warning text-white tracking-widest">Login</Link>
                            </>
                    }
